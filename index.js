...
<html>
   <head>
      ...
      <meta name="description" content="A permissions calculator for Discord - Unofficial.">
      <link rel="icon" type="image/ico" href="https://discord.com/assets/847541504914fd33810e70a0ea73177e.ico" />
      <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@200;300;400;500;600;700;800&amp;display=swap" rel="stylesheet">
      <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.13.1/css/all.css" integrity="sha384-B9BoFFAuBaCfqw6lxWBZrhg/z4NkwqdBci+E+Sc2XlK/Rz25RYn8Fetb+Aw5irxa" crossorigin="anonymous">
      <script src="script.js" async></script>
      <link rel="stylesheet" href="style.css" >
      <title>Permissions Calculator - Discord | Unofficial</title>
   </head>
   <body class="select-none" draggable="false">
      <div class="header">
         <img draggable="false" class="left-link logo select-none" src="https://discord.com/assets/2f71ab5383293f63985ac8d5c632b3d4.png"/>
      </div>
      <div class="container stacky-footer">
         <div class="oauth">
            ...
            <p>
               <span>Client ID: <input style="color:white" class="i-w" id="clientID" type="text" placeholder="264811613708746752" onkeyup="recalculate()"></span>
               <br>
               <span>Invitation Link: <a href="#" id="invite" style="text-decoration: none;"></a></span>
               <br>
               <span>Calculated Permissions: <span id="number" style="color:white">0</span>&nbsp;<code id="equation">0x0</code></span>
            <div class="selector" >
               ...
               <div class="col-me-maybe">
                  <span>Redirect URI: <input style="color:white" class="i-w" id="oauthRedirect" type="text" placeholder="(optional)" onkeyup="recalculate()"></span>
               </div>
               <div class="col-me-maybe">
                  <span>Scope: <input style="color:white" class="i-w" id="oauthScopes" type="text" placeholder="bot" onkeyup="recalculate()"></span>
               </div>
            </div>
            </p>
         </div>
            ...
            <div class="col-me-maybe">
               ...
               <ul>
                  <li>
                     ...
                     <label class="red-f2a" for="generalAdministrator">Administrator</label>
                  </li>
                  <li>
                     <input id="generalManageChannels" type="checkbox" onclick="recalculate()">
                     <label class="red-f2a" for="generalManageChannels">Manage Channels</label>
                  </li>
                  <li>
                     <input id="generalManageRoles" type="checkbox" onclick="recalculate()">
                     <label class="red-f2a" for="generalManageRoles">Manage Roles</label>
                  </li>
                  <li>
                  ...
                  <li>
                     ...
                     <label class="red-f2a" for="generalManageWebhooks">Manage Webhooks</label>
                  </li>
                  <li>
                     <input id="generalManageGuild" type="checkbox" onclick="recalculate()">
                     <label class="red-f2a" for="generalManageGuild">Manage Server</label>
                  </li>
                  <li>
                  ...
                  <li>
                     ...
                     <label class="red-f2a" for="generalKickMembers">Kick Members</label>
                  </li>
                  <li>
                     <input id="generalBanMembers" type="checkbox" onclick="recalculate()">
                     <label class="red-f2a" for="generalBanMembers">Ban Members</label>
                  </li>
               </ul>
            </div>
            <div class="col-me-maybe">
               ...
               <ul>
                  ...
                  <li>
                     ...
                     <label class="red-f2a" for="textManageMessages">Manage Messages</label>
                  </li>
                  <li>
         ...
         <br>
         <center>
            <a href="https://discord.gg/T4BMtSu" target="_blank"><img draggable="false" clas="select-none" src="https://discordapp.com/api/guilds/361066650872840192/embed.png?style=banner2" style="border-radius:4px"></a>
         </center>
         <br>
      </div>
   </body>
